...
func (uu *UserUpdate) SetScopes(s schema.Scope) *UserUpdate {
	uu.mutation.SetScopes(s)
	return uu
}

// SetNillableScopes sets the "scopes" field if the given value is not nil.
func (uu *UserUpdate) SetNillableScopes(s *schema.Scope) *UserUpdate {
	if s != nil {
		uu.SetScopes(*s)
	}
	return uu
...
// SetScopes sets the "scopes" field.
func (uuo *UserUpdateOne) SetScopes(s schema.Scope) *UserUpdateOne {
	uuo.mutation.SetScopes(s)
	return uuo
}

// SetNillableScopes sets the "scopes" field if the given value is not nil.
func (uuo *UserUpdateOne) SetNillableScopes(s *schema.Scope) *UserUpdateOne {
	if s != nil {
		uuo.SetScopes(*s)
	}
	return uuo
...
func (uuo *UserUpdateOne) check() error {
	...
	if v, ok := uuo.mutation.Scopes(); ok {
		if err := user.ScopesValidator(string(v)); err != nil {
			return &ValidationError{Name: "scopes", err: fmt.Errorf(`ent: validator failed for field "User.scopes": %w`, err)}
		}
	}
